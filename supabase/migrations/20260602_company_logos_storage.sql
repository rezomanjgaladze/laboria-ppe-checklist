-- Private, user-scoped company logo storage for Laboria Orbit.
...
drop policy if exists "Users can read their own company logo" on storage.objects;
create policy "Users can read their own company logo"
on storage.objects
for select
to authenticated
using (
